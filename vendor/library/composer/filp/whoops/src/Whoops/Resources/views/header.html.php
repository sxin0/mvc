<div class="exception">
  <div class="exc-title">
    ...
    <?php endforeach ?>
    <?php if ($code): ?>
      <span title="异常代码">(<?php echo $tpl->escape($code) ?>)</span>
    <?php endif ?>
  </div>
  ...
  <div class="exc-message">
    ...
    <ul class="search-for-help">
      ...
      <li>
        <a target="_blank" href="<?php echo $docref_url; ?>" title="在PHP手册中寻找帮助.">
          <!-- PHP icon by Icons Solid -->
          <!-- https://www.iconfinder.com/icons/322421/book_icon -->
          <!-- Free for commercial use -->
            <svg height="16px" id="Layer_1" style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" width="16px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><g transform="translate(240 0)"><path d="M-211,4v26h-24c-1.104,0-2-0.895-2-2s0.896-2,2-2h22V0h-22c-2.209,0-4,1.791-4,4v24c0,2.209,1.791,4,4,4h26V4H-211z    M-235,8V2h20v22h-20V8z M-219,6h-12V4h12V6z M-223,10h-8V8h8V10z M-227,14h-4v-2h4V14z"/></g></svg>
        </a>
      </li>
      <?php endif ?>
      <li>
        <a target="_blank" href="https://google.com/search?q=<?php echo urlencode(implode('\\', $name).' '.$message) ?>" title="在谷歌上搜索帮助.">
      ...
      <li>
        <a target="_blank" href="https://duckduckgo.com/?q=<?php echo urlencode(implode('\\', $name).' '.$message) ?>" title="在&nbsp;DuckDuckGo&nbsp;下寻求帮助.">
      ...
      <li>
        <a target="_blank" href="https://stackoverflow.com/search?q=<?php echo urlencode(implode('\\', $name).' '.$message) ?>" title="在堆栈溢出上搜索帮助.">
        ...
        <li>
            <a target="_blank" href="https://www.baidu.com/baidu?wd=<?php echo $message ?>" title="在百度上搜索帮助." style="color: white; font-size: 13px;">
                <!-- Google icon by Alfredo H, from https://www.iconfinder.com/alfredoh -->
                <!-- Creative Commons (Attribution 3.0 Unported) -->
                <!-- http://creativecommons.org/licenses/by/3.0/ -->
                百度
        ...
        <li>
            <a target="_blank" href="https://www.w3cschool.cn/search?w=<?php echo $message; ?>" title="在W3cSchool上搜索帮助." style="color: white; font-size: 13px;">
                <!-- Google icon by Alfredo H, from https://www.iconfinder.com/alfredoh -->
                <!-- Creative Commons (Attribution 3.0 Unported) -->
                <!-- http://creativecommons.org/licenses/by/3.0/ -->
                W3cSchool
    ...
    <button id="copy-button" class="clipboard" data-clipboard-text="<?php echo $tpl->escape($plain_exception) ?>" title="将异常细节复制到剪贴板" style="border: 1px solid white; color: white;">
        复制
    </button>
  </div>
</div>
